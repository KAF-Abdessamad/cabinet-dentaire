...
@section('title', 'Modifier Rendez-vous - Cabinet Dentaire')
...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="mb-8">
            <a href="{{ route('appointments.show', $appointment) }}" class="inline-flex items-center text-gray-600 hover:text-sky-500 transition-colors mb-4">
                    ...
                    <div>
                        ...
                        <select name="user_id" id="user_id" required
                            ...
                            @foreach($dentists as $dentist)
                                <option value="{{ $dentist->id }}" {{ (old('user_id') ?? $appointment->user_id) == $dentist->id ? 'selected' : '' }}>
                                    Dr. {{ $dentist->name }}
                                </option>
                            @endforeach
                        </select>
