...
<body>
    ...
    <div class="content">
        ...
        <p>Nous vous rappelons que vous avez rendez-vous <strong>demain</strong> dans notre cabinet. Voici les détails :</p>
        ...
        <p style="background: #dbeafe; padding: 15px; border-radius: 8px; border-left: 4px solid #3b82f6;">
            ...
            • Si vous ne pouvez pas vous présenter, merci de nous contacter au plus vite pour libérer ce créneau.
        </p>
